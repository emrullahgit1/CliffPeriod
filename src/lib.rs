...
#[derive(Debug)]
pub struct CliffPeriodProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CliffPeriodProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CliffPeriod processing");
    
    let mut processor = CliffPeriodProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CliffPeriodProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CliffPeriodProcessor::new(false);
